    ...
    <body>
        <div class="boven">
            <div class="links-boven">
                <div class="gesprekje">
                    <div class="titel"><h3>Studenten die met je willen praten</h3></div>
            ...
            <div class="rechts-boven">
                <div class="lage-cijfers">
                    <div class="titel"><h3>Studenten met een laag cijfer</h3></div>
